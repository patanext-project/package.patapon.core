...
namespace PataNext.Client.Graphics.Animation.Units.CTate
{
	...
	public class TaterazayEnergyFieldAbilityAnimation : BaseAbilityAnimationSystem
	<
		TaterazayEnergyFieldAbilityAnimation.SystemPlayable,
		TaterazayEnergyFieldAbilityAnimation.PlayableInitData,
		TaterazayEnergyFieldAbilityAnimation.SystemData
	>
	{
