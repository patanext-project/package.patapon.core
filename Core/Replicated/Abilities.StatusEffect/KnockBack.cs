...
{
	public struct KnockBackState : IStatusEffectState
	{
	...
	public struct KnockBackSettings : IStatusEffectSettings
	{
		public float Resistance     { get; set; }
		public float RegenPerSecond { get; set; }
		public float Power          { get; set; }
		...
		public class Register : RegisterStatusEffectSystemSettings<KnockBackSettings>
		{
		}
	}
}