	...
	public partial class MpVersusHeadOnGameMode
	{
		public class PlayLoopBlock : BlockCollection
		{
			...
			protected override bool OnRun()
			{
				...
				ref var gameModeData = ref m_HeadOnContext.Data;

				// ----------------------------- //
				// Elimination events
				var eliminationEvents = m_HeadOnContext.EliminationEvents;
				...
				var captureEvents = m_HeadOnContext.CaptureEvents;
				for (int i = 0, length = captureEvents.Length; i < length; i++)
				{
					...
					for (var h = 0; h != healthContainer.Length; h++)
					{
						...
						var value = m_HeadOnContext.Teams[team].AveragePower;
