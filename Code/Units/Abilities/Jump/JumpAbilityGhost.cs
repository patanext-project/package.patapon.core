...
namespace Patapon4TLB.Default
{
	...
	public struct JumpAbilityGhostSerializer : IGhostSerializer<JumpAbilitySnapshotData>
	{
		...
		[NativeDisableContainerSafetyRestriction]
		private ComponentDataFromEntity<RhythmCommandId> m_CommandIdFromEntity;
		...
		public void BeginSerialize(ComponentSystemBase system)
		{
			...
			m_CommandIdFromEntity  = system.GetComponentDataFromEntity<RhythmCommandId>();
		}
		...
		public void CopyToSnapshot(ArchetypeChunk chunk, int ent, uint tick, ref JumpAbilitySnapshotData snapshot)
		{
			...
			snapshot.CommandId       = rhythmAbilityState.Command == default ? 0 : m_CommandIdFromEntity[rhythmAbilityState.Command].Value;

			var owner = chunk.GetNativeArray(GhostOwnerType.Archetype)[ent];
			snapshot.OwnerGhostId = m_GhostStateFromEntity.GetGhostId(owner.Target);
		}
	}
