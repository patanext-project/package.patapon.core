...
[assembly: RegisterGenericComponentType(typeof(Predicted<UnitTranslationSnapshot>))]

namespace Patapon4TLB.Core.Snapshots
{
	public struct UnitTranslationSnapshot : IReadWriteSnapshot<UnitTranslationSnapshot>, IPredictable<UnitTranslationSnapshot>,
	                                                ISynchronizeImpl<Translation>,
	                                                ISynchronizeImpl<UnitTranslationSnapshot.NetSynchronize.TargetPosition>
	{
		...
		public void WriteTo(DataStreamWriter writer, ref UnitTranslationSnapshot baseline, NetworkCompressionModel compressionModel)
		{
			for (var i = 0; i < dimension; i++)
				writer.WritePackedIntDelta(Value[i], baseline.Value[i], compressionModel);
		}

		public void ReadFrom(ref DataStreamReader.Context ctx, DataStreamReader reader, ref UnitTranslationSnapshot baseline, NetworkCompressionModel compressionModel)
		{
			for (var i = 0; i < dimension; i++)
		...
		public void Interpolate(UnitTranslationSnapshot target, float factor)
		{
		...
		public class NetSynchronize : ComponentSnapshotSystemBasicPredicted<Translation, UnitTranslationSnapshot>
		{
		...
		[DisableAutoCreation]
		public class TranslationPredictedUpdate : ComponentUpdateSystemInterpolated<Translation, UnitTranslationSnapshot>
		{
		...
		public void PredictDelta(uint tick, ref UnitTranslationSnapshot baseline1, ref UnitTranslationSnapshot baseline2)
		{
