...
{
	public struct TranslationInterpolatedSnapshot : IReadWriteSnapshot<TranslationInterpolatedSnapshot>, ISnapshotDelta<TranslationInterpolatedSnapshot>, ISynchronizeImpl<Translation>, IInterpolatable<TranslationInterpolatedSnapshot>
	{
		public const int    dimension = 2;
		public       float2 Value;

		public void WriteTo(DataStreamWriter writer, ref TranslationInterpolatedSnapshot baseline, NetworkCompressionModel compressionModel)
		{
			for (var i = 0; i < dimension; i++)
				writer.WritePackedFloatDelta(Value[i], default, compressionModel);
		}

		public void ReadFrom(ref DataStreamReader.Context ctx, DataStreamReader reader, ref TranslationInterpolatedSnapshot baseline, NetworkCompressionModel compressionModel)
		{
			for (var i = 0; i < dimension; i++)
		...
		public bool DidChange(TranslationInterpolatedSnapshot baseline)
		{
		...
		public class NetSynchronize : ComponentSnapshotSystemBasic<Translation, TranslationInterpolatedSnapshot>
		{
			...
			public override NativeArray<ComponentType> EntityComponents =>
				...
				{
					[0] = typeof(TranslationDirectSnapshot.Exclude),
					[1] = typeof(Use),
					[2] = typeof(Translation)
				};
		}

		public class LocalUpdate : ComponentUpdateSystemInterpolated<Translation, TranslationInterpolatedSnapshot>
		{
		}

		public void Interpolate(TranslationInterpolatedSnapshot target, float factor)
		{
