namespace Patapon4TLB.Default
{
	...
	{
		/// <summary>
		/// Unknown status effect, it may be a custom one?
		/// </summary>
		Unknown = 0,
		...
		/// <summary>
		/// Freeze effect.
		/// The first level (less than 100%) will make the target being slowed down (movement speed and attack speed -50%) and apply a small DOT
