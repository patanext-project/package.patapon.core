...
{
	public struct KibaddaRushAttack : IComponentData
	{
		public float  AttackDelay;
		public Entity AttackHitBox;

		public class Provider : BaseRhythmAbilityProvider<KibaddaRushAttack>
		{
			public override    string MasterServerId   => nameof(P4OfficialAbilities.KibaRushAttack);
			...
			public override void SetEntityData(Entity entity, CreateAbility data)
			{
				...
				EntityManager.SetComponentData(entity, new KibaddaRushAttack {AttackHitBox      = hitbox});
		...
		public class System : BaseAbilitySystem
		{
			protected override void OnUpdate()
			{
				...
				Entities.ForEach((ref KibaddaRushAttack ability, ref AbilityControlVelocity control, in AbilityState state, in AbilityEngineSet engineSet, in Owner owner) =>
				{
